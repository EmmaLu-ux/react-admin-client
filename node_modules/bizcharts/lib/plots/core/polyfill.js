...
exports.polyfillAxis = function (cfg, name) {
    ...
    exports.polyfillVisible(options, 'line', null);
    exports.polyfillVisible(options, 'grid', null);
    exports.polyfillVisible(options, 'label', null);
    exports.polyfillVisible(options, 'tickLine', null);
    exports.polyfillVisible(options, 'title', null);
